...
import AttributePreview from "../../components/gunwoo/time-graph/AttributePreiview";
import SensorSearch from "../../components/gunwoo/sensor-entry-page/SensorSearch";
import Chart from "../../components/gunwoo/time-graph/Chart";
  ...
  return (
    <>
      ...
      <Container>
        ...
        <Notification>
          {selectedSensors.length === 5 ? "최대 5개까지 선택 가능" : null}
        </Notification>
        <Wrapper>
